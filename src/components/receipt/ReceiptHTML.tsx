...
const formatDate = (dateString: string | Date | undefined): string => {
  ...
  if (dateString instanceof Date) {
    return formatAdminDateTime(dateString.toISOString());
  }
  return formatAdminDateTime(String(dateString));
};
      ...
      <div className={styles.body}>
        <div className={styles.section}>
          ...
          <div className={styles.row}>
            ...
            <span className={styles.value}>{formatDate(transaction.date)}</span>
          </div>
            ...
            <>
              ...
              {nextPurchaseDate && (
                <div className={styles.row}>
                  ...
                  <span className={styles.value}>{formatDate(nextPurchaseDate)}</span>
                </div>
              )}
              <div className={styles.sectionDivider} />
              <div className={styles.noteBox}>
                <p>
                  ℹ️ Please ensure you have sufficient funds in your wallet before the scheduled
                  date.
                </p>
                <p>ℹ️ Scheduled purchases cannot be canceled once confirmed.</p>
              </div>
            </>
          )}
        </div>
